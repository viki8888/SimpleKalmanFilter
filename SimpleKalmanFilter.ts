...
namespace SimpleKalmanFilter {
    ...
    export class kalman{
        ...
        getAngle(newAngle: number, newRate: number,dt:number): number{
            /* Step 1 */
            ...
            /* Step 7 */
            let P00_temp:number = this.P[0][0];
            let P01_temp:number = this.P[0][1];
        ...
        getRate():number { return this.rate; }; // Return the unbiased rate
        ...
        getQangle():number { return this.Q_angle; };
        getQbias() :number{ return this.Q_bias; };
        getRmeasure():number { return this.R_measure; };
